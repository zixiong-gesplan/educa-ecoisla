...
export const Actions = () => {
  return (
    <section id="actividades" className="mx-4 max-w-screen-xl">
      <h2 className="m-6 text-2xl w-full text-center text-gray-900 font-extrabold">
        ACTIVIDADES
      </h2>
      ...
      <div className=" w-full flex justify-center items-center">
        <Link
          href="/gallery"
          className="text-lima text-lg sm:text-2xl text-center mt-6"
        >
          Accede a todas las actividades realizadas
        </Link>

        <svg
          className="w-6 h-6 text-lima dark:text-white  mt-6"
          aria-hidden="true"
