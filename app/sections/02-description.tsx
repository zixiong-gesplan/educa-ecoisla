				...
				<div className="mr-auto place-self-center xl:col-span-7">
					...
					<div className="mt-6 w-[200px] lg:w-2/3 flex justify-start gap-3" >
						...
						<button className="flex items-center justify-between border-custom-dark-green border-4 text-custom-dark-green bg-white rounded-lg px-4 py-2 w-60 lg:w-[300px]">
							<div className="w-2/3 text-center flex justify-center items-center">Próxima actividad</div>
							<svg className="w-12 h-12 text-custom-dark-green dark:text-white content-center" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
