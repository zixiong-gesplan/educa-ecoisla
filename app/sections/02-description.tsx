...
export const Description = () => {
    return       <section className="m-4 mt-2 text-xl mx-auto max-w-screen-xl px-8">
    <div className="bg-[#83AC50] p-8">
    ...
    <div className="flex flex-col lg:flex-row lg:pt-8 m-0 items-center  mt-4">
