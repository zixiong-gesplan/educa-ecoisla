			...
			<div className="grid max-w-screen-xl px-0 sm:px-2 py-8 mx-4 lg:gap-8 xl:gap-0 lg:py-16 xl:grid-cols-12">
				<div className="mr-auto place-self-center xl:col-span-7">
					...
					<div className="mt-6 w-[200px] lg:w-2/3 flex justify-start gap-2" >
						<button className="flex items-center justify-between text-white bg-custom-green-800 hover:bg-custom-green-900 rounded-lg mr-1 px-4 py-2 w-60 lg:w-[300px]">
						...
						<button className="flex items-center justify-between text-custom-dark-green bg-custom-light-bg bg-opacity-20 hover:bg-opacity-40 rounded-lg px-4 py-2 w-60 lg:w-[300px]">
