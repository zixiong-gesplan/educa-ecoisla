...
export const ButtonDark = ({ content, d, href="#" }: Props) => {
    return (
        <Link href={href} className="flex items-center justify-between text-white bg-custom-green-800 hover:bg-custom-green-900 rounded-lg px-4 py-2 w-full md:w-[300px]">
